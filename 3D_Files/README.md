These files are made available to help people to create a shell for the device.
Please note that the silkscreen may not be up to date on these 3d files.
Most of the files are in step format but the ones that aren't was because ther were too big >20MByte.
